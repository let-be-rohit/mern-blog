...
export default function DashProfile() {
  ...
  const [updateUserSeccess, setUpdateUserSeccess] = useState(null);
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if(!res.ok){
        ...
        setUpdateUserSeccess("User's profile updated successfully");
      }
    } catch (error) {
  ...
  return (
    <div className='mx-w-lg mx-auto p-3 w-full'>
      ...
      <form onSubmit={handleSubmit} className='flex flex-col gap-4'>
        ...
        shadow-md overflow-hidden rounded-full' onClick={() =>
